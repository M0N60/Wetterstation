...
<body>
    ...
    <section class="hidden bubble_rot">
        <h2>Die aktuelle <br> Temperatur beträgt: </h2>
        <p> 
            <?php 
                number_format($Temperatur,2,",",".");
                echo "$Temperatur"; 
            ?> °C 
        </p> 
    ...
    <section class="hidden blue">
        <h2>Der Niederschlags pro Stunde beträgt:</h2>
        <p> 
            <?php 
                number_format($Niederschlag,2,",",".");
                echo "$Niederschlag"; 
            ?> l/m²
        </p>
    ...
    <section class="hidden ">
        <h2> Die aktuelle Windrichtung beträgt:</h2>
        <p> 
            <?php echo "$Windrichtung";?>
        </p>

    </section>

    <section class="hidden bubble_schwartz">
        <h2> Die aktuelle <br>Windgeschwindigkeit beträgt:</h2>
        <p> 
            <?php 
                number_format($Windgeschwindigkeit,2,",",".");
                echo "$Windgeschwindigkeit"; 
            ?> m/s 
        <br> 
            <?php 
                echo "$Windgeschwindigkeit_kmh"; 
            ?> km/h 
        </p>   
    </section>

    <section class="hidden white">
        <h2> Der aktuelle Luftdruck beträgt:</h2>
        <p> 
            <?php 
                number_format($Luftdruck,2,",",".");
                echo "$Luftdruck"; 
            ?> hPa 
        <br> 
        <?php 
    ...
    <section class="hidden pink">
        <h2> Die aktuelle Luftfeuchtigkeit beträgt:</h2>
        <p> 
            <?php 
                number_format($Luftfeuchtigkeit,2,",",".");
    ...
    <section class="hidden">
        <h3> 
            Hier sehen Sie die Werte graphisch dargestellt:
        </h3>
        <div class="bilder">
