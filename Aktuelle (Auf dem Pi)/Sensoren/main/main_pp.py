...
# die while schleife zu einerfuntion gemacht die nur einaml ausgefürt wird
def get_werte():
    #werte auslesen
    bme_rotine()
    ...
    #!!!!!!!!bei der Vorführung hier stoppen (?????? keinen loop machen ????)  beim normalen benutzen dann mit loop !!!!!!!