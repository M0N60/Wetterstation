...
#!NIEDERSCHALG! 
# UNTER DER BEDINGUNG DAS ES BEI DER HÄLFTE CA SCHALTET WIRD UND  mess_zeit== 60!!
...
#! WINDGESCHWINDIKEIT! 
#  cups durchmesser (cup-to-cup in mm)
cups_diameter = float(106)

#  cups Umfang in meter
cups_circ = float (cups_diameter/1000)*3.1415

# um es genauer zu machen (war etwas raten XD)
afactor = float(2.5)

# endtime ist die aktuelle Zeit plus einen endwert
...
def windgeschwindikeit_rotine(schalt_wert_lichtschranke,mess_zeit):
    ...
    windspeed = float((rots_per_second)*cups_circ*afactor)
